...
rawPath = "results/csv/"
dataPath = "results/Patamon/"
# if not os.path.exists(dataPath):
#     os.makedirs(dataPath)
# filenames = os.listdir(rawPath)
# datanames = [filename for filename in filenames
#             if filename.startswith("Patamon") and not filename.endswith("R.csv") and not filename.endswith("M.csv")]
# datanames.sort()
...
#     dataname,rewardname,mapname,rawPath = argument
#     print(dataname)
#     toPkl(argument)

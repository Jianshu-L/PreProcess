...
%                 if obj.timeLength > 2
%                     % about 4 spikes per second
%                     LeastFiringCount = 2*4*3600;
%                 else
%                     LeastFiringCount = obj.timeLength*4*3600 > 30000;
%                 end
            end
            LeastFiringCount = 10000;
...
%                     fileName_ = fileName(fi);
        ...
        function csvNames = doKlusta(obj, folderName)
